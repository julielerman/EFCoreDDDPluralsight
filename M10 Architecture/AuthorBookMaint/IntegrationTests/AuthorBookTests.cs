...
public class AuthorBookTests
{
    ...
    [TestMethod]
    public void CanSerializeAndRetrieveAuthor()
    {
        var author = new Author(new PersonName("first", "last"),
                       "firsty", "he/his", "");
        _context.Authors.Add(author);
        _context.SaveChanges();
        _context.ChangeTracker.Clear();
        var authorFromDB = _context.Authors.FirstOrDefault();
        var expected = JsonSerializer.Serialize(author);
        var actual = JsonSerializer.Serialize(authorFromDB);
    ...
    {   
        ...
        CollectionAssert.AreEqual(listOfIds, bookFromDB.AuthorIds.ToList());
    }
