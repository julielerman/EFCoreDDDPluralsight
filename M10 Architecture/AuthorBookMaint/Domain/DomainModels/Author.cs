...
public class Author : BaseEntity<Guid>
{
    ...
    public static Author CreateFromNewContractMessage(PersonName name, string email, Guid contractId)
    {
        var newauthor = new Author();
        newauthor.Name = name;
        newauthor.Id = Guid.NewGuid();
        newauthor.AddContractViaId(contractId);
        newauthor.EmailAddress = email;
        newauthor.PreferredName = "tbd";
        newauthor.Pronouns = "tbd";
        return newauthor;
    }
