...
namespace IntegrationTests
{
    ...
    public class ContractSearchTests
    {
        ...
        {
         var c1 = new Contract(
        DateOnly.FromDateTime(DateTime.Today.AddDays(-10)), new List<Author> { Author.UnsignedAuthor("Stonna", "Edelman", "s@stonna.com", "800-stonna") }, "A Book"
        );

            var c2 = new Contract(
DateOnly.FromDateTime(DateTime.Today.AddDays(-2)), new List<Author> { Author.UnsignedAuthor("Julie", "Lerman", "j@julie.com", "800-julie") }, "Another Book"
);
            c2.AddAuthor(Author.UnsignedAuthor("Roland", "Guijt", "r@roland.com", "800-roland"));
            var c3 = new Contract(
DateOnly.FromDateTime(DateTime.Today), new List<Author> { Author.UnsignedAuthor("Liz", "Lemon", "l@liz.com", "800-liz") }, "Book II"
);
