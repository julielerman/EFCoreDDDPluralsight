...
public class EventHandlerTests
{
    Contract _contract = new Contract(
       DateOnly.FromDateTime(DateTime.Today), new List<Author> { Author.UnsignedAuthor("first", "last","email","phone") },
       "booktitle" );
    ...
    private void CreateNewContractAndAddRevision()
    {
        ...
        contractFromDB.CreateRevisionUsingSameSpecs
            (ContractBC.Enums.ModReason.Other, "abc", v1.WorkingTitle, v1.AuthorsCopy().ToList(), null);
    ...
    private void CreateNewContractAndAddRevisionWithNewSpecs()
    {
        ...
        contractFromDB.CreateRevisionUsingNewSpecs
            (ContractBC.Enums.ModReason.Other, "abc", v1.WorkingTitle, v1.AuthorsCopy().ToList(), null,DefaultSpecsFactory.Create());
