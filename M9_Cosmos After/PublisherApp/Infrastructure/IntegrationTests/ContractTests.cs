...
public class ContractTests
{
    ...
    public ContractTests()
    {
        ...
        optionsBuilder.UseCosmos("your cosmos http endpoint", "your secret key",
    ...
    {   var assignedId = _contract.Id;
        _contract.AddNewComments("abc");
        //_contract.randomguids.Add(Guid.NewGuid());
    ...
    public void NewContractHasVersionWithSpecDefaults()
    {
        ...
        var contractFromDB = _context.Contracts.FirstOrDefault();
        Assert.AreEqual(DefaultSpecsFactory.Create(), contractFromDB.Versions.First().Specs);
    }
    ...
    [TestMethod] //Works with earlier and current versions of EF Core 
    ...
    public void CanPersistAuthorSocialMediaDictionary()
    {
        ...
        var contract = new Contract(DateOnly.FromDateTime(DateTime.Today),
            new List<Author> { author }, "I wrote a book!");
    ...
    public void FullContractAggregateWithSocialMediaAndCommentsPersistedandRetrieved()
    {
        ...
        author.AddSocialMedia(SocialMedia.Twitter, "julielerman");
        author.AddSocialMedia(SocialMedia.Mastadon, "@julielerman@mas.to");
        var contract = new Contract(DateOnly.FromDateTime(DateTime.Today), new List<Author> { author }, "I wrote a book!");
