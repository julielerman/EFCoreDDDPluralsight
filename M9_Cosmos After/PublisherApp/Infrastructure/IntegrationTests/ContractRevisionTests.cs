...
public class ContractRevisionTests
{
    ...
    //[TestMethod] //not supported by cosmos
    ...
    public void RevisonUsingSameSpecsStoresHasRevisedAsFalse()
    {
        ...
        var versionEntry = _context.Entry
            (contract.Versions.OrderByDescending(v=>v.DateCreated).FirstOrDefault());
    ...
    public void PersistedContractWithRevisonAndSameAuthorsDuplicatesAuthorInDatabase()
    {
        ...
        //    }).FirstOrDefault();
        var contractFromDB = _context.Contracts.FirstOrDefault();
        var newVersion = contractFromDB.Versions.FirstOrDefault(v => v.Id == contractFromDB.CurrentVersionId);
